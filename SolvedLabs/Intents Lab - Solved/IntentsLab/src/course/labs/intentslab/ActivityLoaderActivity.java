...
public class ActivityLoaderActivity extends Activity {
	...
	private void startExplicitActivation() {
		...
		Intent explicitIntent = new Intent(Intent.ACTION_GET_CONTENT);
		explicitIntent.setClass(ActivityLoaderActivity.this, ExplicitlyLoadedActivity.class);
	...
	private void startImplicitActivation() {
		...
		Intent implicitIntent = new Intent(Intent.ACTION_VIEW, uriString);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (requestCode == GET_TEXT_REQUEST_CODE) {
			...
			if (resultCode== RESULT_OK) {
				mUserTextView.setText(data.getStringExtra("input_string"));
				//String string = data.getStringExtra("input_string");
