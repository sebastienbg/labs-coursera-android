		...
		mApplicationContext.sendOrderedBroadcast(
				new Intent(MainActivity.DATA_REFRESHED_ACTION), null, new BroadcastReceiver() {
					...
					public void onReceive(Context context, Intent intent) {
						...
						//TODO: Check whether the result code is RESULT_OK falso comprobar si es distinto
						if (getResultCode()!=Activity.RESULT_OK) {
							...
							final PendingIntent pendingIntent = PendingIntent
									.getActivity(mApplicationContext, 0, restartMainActivtyIntent, PendingIntent.FLAG_UPDATE_CURRENT);
